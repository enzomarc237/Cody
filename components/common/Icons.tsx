...
export const BotIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5l.415-.207a.75.75 0 011.085.67V10.5m0 0h6m-6 0a.75.75 0 001.085.67l.415-.207M8.25 10.5V7.5m0 3H7.5m1.5 0a.75.75 0 01-1.5 0m1.5 0v3.75m-1.5-3.75H7.5m9-6h.008v.008H16.5v-.008zm1.5 0h.008v.008H18v-.008zm1.5 0h.008v.008H19.5v-.008zm-1.5 3h.008v.008H18v-.008zm1.5 0h.008v.008H19.5v-.008zm-1.5 3h.008v.008H18v-.008zm1.5 0h.008v.008H19.5v-.008z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 18.75a6 6 0 016-6 6 6 0 016 6v.75a1.5 1.5 0 01-1.5 1.5H7.5A1.5 1.5 0 016 19.5v-.75z" />
    </svg>
);
